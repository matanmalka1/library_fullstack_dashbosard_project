    ...
    <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
      <div>
        ...
        <p className="text-xs text-slate-500 mt-2">
          Select reviews to approve or delete in bulk.
        </p>
      </div>
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <button
          ...
          className="border-0 rounded-full px-4 py-2 text-[10px] uppercase tracking-[0.16em] font-bold bg-emerald-600 text-white cursor-pointer transition disabled:opacity-50 disabled:cursor-not-allowed"
          type="button"
        >
          Approve Selected
        </button>
        <button
          ...
          disabled={!selectedIds?.size}
          className="border-0 rounded-full px-4 py-2 text-[10px] uppercase tracking-[0.16em] font-bold bg-red-600 text-white cursor-pointer transition disabled:opacity-50 disabled:cursor-not-allowed"
          type="button"
        >
          Delete Selected
        </button>
    ...
    {pendingReviews.length > 0 ? (
      <div className="grid gap-6">
        <div className="flex items-center justify-between text-xs text-slate-500">
          ...
          <span>{selectedIds?.size || 0} selected</span>
        </div>
